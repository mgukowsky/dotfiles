...
# Various zsh options; mainly from https://github.com/tonylambiris/dotfiles/blob/master/dot.zshrc
setopt auto_pushd               # pushd each time you cd
...
# Seems to not be needed with starship setup, but here in case I need something like this in
# the future
#
...
# zsh-completions should be picked up automatically on arch linux if the package is installed
