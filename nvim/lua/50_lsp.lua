		...
		["<leader>"] = {
			d = {
				q = {
					d = {
						function()
							util.run_if_compile_commands(cpp_util.dbg_select)
						end,
						"Select program to debug",
					},
					D = {
						function()
							util.run_if_compile_commands(cpp_util.run_gtest_at_cursor)
						end,
